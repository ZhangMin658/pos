    ...
    <div class="row">
      ...
      <div class="col-xl-4 col-md-12 col-sm-12">
        <div class="card">
          <div class="card-content">
            <div class="card-body">
              <h4 class="card-title mb-1">Feedback Form</h4>
              <form class="form">
                <div class="form-body">
    ...
    <div class="row">
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card border-warning text-center bg-transparent">
          <div class="card-content">
            <div class="card-body">
              <img src="{{ asset('images/elements/magic-mouse.png') }}" alt="element 05" width="150" class="mb-1">
      ...
      <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="card border-danger text-center bg-transparent">
          <div class="card-content d-flex">
            <div class="card-body">
              <img src="{{ asset('images/elements/ipad-pro.png') }}" alt="element 06" height="100" class="mb-1">
