        ...
        <div class="card-content">
          <div class="card-body">
            ...
            <div class="default-collapse collapse-bordered">
              ...
              <div class="card collapse-header">
                <div id="headingCollapse3" class="card-header collapse-header" data-toggle="collapse" role="button"
          ...
          <div class="card-content">
            <div class="card-body">
              ...
              <div class="accordion-shadow collapse-bordered">
                <div class="card collapse-header">
                  <div id="heading11" class="card-header" data-toggle="collapse" role="button"
                    data-target="#accordion10" aria-expanded="false" aria-controls="accordion10">
                    <span class="lead collapse-title">
                      Accordion Item 1
                    </span>
                  </div>
                ...
                <div class="card collapse-header">
                  <div id="heading20" class="card-header" data-toggle="collapse" role="button"
                    data-target="#accordion20" aria-expanded="false" aria-controls="accordion20">
                    <span class="lead collapse-title">
                      Accordion Item 2
                    </span>
                  </div>
                ...
                <div class="card collapse-header">
                  <div id="heading30" class="card-header" data-toggle="collapse" role="button"
                    data-target="#accordion30" aria-expanded="false" aria-controls="accordion30">
                    <span class="lead collapse-title">
                      Accordion Item 3
                    </span>
                  </div>
                ...
                <div class="card collapse-header">
                  <div id="heading40" class="card-header" data-toggle="collapse" role="button"
                    data-target="#accordion40" aria-expanded="false" aria-controls="accordion40">
                    <span class="lead collapse-title">
                      Accordion Item 4
                    </span>
                  </div>
            ...
            <div class="card-body">
              ...
              <div class="accordion" id="accordionExample0">
                <div class="collapse-border-item collapse-header card collapse-bordered">
                  <div class="card-header" id="heading200" data-toggle="collapse" role="button"
                ...
                <div class="collapse-border-item card collapse-header">
                  <div class="card-header" id="heading210" data-toggle="collapse" role="button"
                    data-target="#collapse210" aria-expanded="false" aria-controls="collapse210">
                    <span class="lead collapse-title">
                      Accordion Item 2
                    </span>
                  </div>
                ...
                <div class="card collapse-header collapse-border-item">
                  <div class="card-header" id="heading220" data-toggle="collapse" role="button"
                    data-target="#collapse220" aria-expanded="false" aria-controls="collapse220">
                    <span class="lead collapse-title">
                      Accordion Item 3
                    </span>
                  </div>
                ...
                <div class="card collapse-header collapse-border-item">
                  <div class="card-header" id="heading230" data-toggle="collapse" role="button"
                    data-target="#collapse230" aria-expanded="false" aria-controls="collapse230">
                    <span class="lead collapse-title">
                      Accordion Item 4
                    </span>
                  </div>
