...
<div class="alert alert-danger" role="alert">
                <h4 class="alert-heading">Switcher Advisor</h4>
                <p class="mb-0">
                  Text Here ... (Error, Alert, notification, System mint., subscription expire date, user control)
                </p>
              </div>
...
<div class="row">
  ...
  <button type="button" class="btn btn-primary mr-1 mb-1 waves-effect waves-light">New Time in</button>
  <button type="button" class="btn btn-primary mr-1 mb-1 waves-effect waves-light">Time Sheet</button>
</div>
  <div class="col-auto">
  <button type="button" class="btn btn-warning mr-1 mb-1 waves-effect waves-light">Time Out</button>
  <button type="button" class="btn btn-info mr-1 mb-1 waves-effect waves-light" data-toggle="modal" data-target="#animation">Closing</button>
  <div class="modal text-left" id="animation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel6" style="display: none;" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel6">Closgin</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true"><i class="fas fa-times" style="color:red;"></i></span>
                    </button>
                  </div>
                  <div class="modal-body">
                                <fieldset class="form-group">
                                  <label for="basicInput">Total Cash</label>
                                  <input type="text" class="form-control" readonly="readonly" value="0.000" >
                                </fieldset>
                                <fieldset class="form-group">
                                  <label for="basicInput">Total Card</label>
                                  <input type="text" class="form-control" readonly="readonly" value="0.000">
                                </fieldset>
                                <fieldset class="form-group">
                                  <label for="basicInput">Total Benefit Pay</label>
                                  <input type="text" class="form-control" readonly="readonly" value="0.000">
                                </fieldset>
                                  <fieldset class="form-group">
                                  <label for="basicInput">Total Unpaid</label>
                                  <input type="text" class="form-control" readonly="readonly" value="0.000">
                                </fieldset>
                                <fieldset class="form-group">
                                  <label for="basicInput">Ground Total</label>
                                  <input type="text" class="form-control" readonly="readonly" value="0.000">
                                </fieldset>
                             </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-info waves-effect waves-light" data-dismiss="modal">Shift Closing</button>
                        <button type="button" class="btn btn-primary waves-effect waves-light" data-dismiss="modal2">Closing</button>
                    </div>
                </div>
              </div>
            </div>
...
<!-- Line Area Chart -->
   <div class="justify-content-center btn-group btn-block" role="group" aria-label="Basic example">
        <a href="/pos" class="btn btn-outline-success mr-1 mb-1 waves-effect waves-light square" role="button">POS</a>
        <a href="/emp_attends" class="btn btn-outline-success mr-1 mb-1 waves-effect waves-light square" role="button">Attends</a>
        <a href="/reports" class="btn btn-outline-success mr-1 mb-1 waves-effect waves-light square" role="button">Reports</a>
        <a href="/deliveries" class="btn btn-outline-success mr-1 mb-1 waves-effect waves-light square" role="button">Deliveries</a>
        <a href="/customer_list" class="btn btn-outline-success mr-1 mb-1 waves-effect waves-light square" role="button">Customer List</a>
        <a href="/customer_list" class="btn btn-outline-success mr-1 mb-1 waves-effect waves-light square" role="button">Daily Report</a>
  </div>
      <div class="card">
                      ...
                      <div class="card-body px-0 pb-0" style="position: relative;">
                          ...
                          <div class="row text-center mx-0">
                              <div class="col-6 border-top border-right d-flex align-items-between flex-column py-1">
                                  ...
                                  <p class="font-large-1 text-bold-700">1090.000</p>
                              </div>
                              <div class="col-6 border-top d-flex align-items-between flex-column py-1">
                                  <p class="mb-50">Target</p>
                                  <p class="font-large-1 text-bold-700">1345.000</p>
                              </div>
                          </div>
