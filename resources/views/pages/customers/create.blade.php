                              ...
                              <div class="row">
                                  <div class="col-md-6 col-12">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {{ $errors->has('cust_name') ? 'is-invalid' : ''}}"  name="cust_name">
                                    ...
                                    <div class="col-md-6 col-12">
                                      <div class="form-group">
                                        ...
                                        <input type="text"  class="form-control {{ $errors->has('cust_mob') ? 'is-invalid' : ''}}" name="cust_mob">
                                  ...
                                  <div class="col-md-6 col-12">
                                      <div class="form-group">
                                        ...
                                        <input type="email"  class="form-control {{ $errors->has('cust_email') ? 'is-invalid' : ''}}" name="cust_email">
                                  ...
                                  <div class="col-md-6 col-12">
                                      <div class="form-group">
                                        <label>Area</label>
                                            <select class="select2 form-control {{ $errors->has('cust_area') ? 'is-invalid' : ''}} select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true" name="cust_area">
                                ...
                                {!! $errors->first('cust_area', '<div class="invalid-feedback">:message</div>') !!}
                                  ...
                                  <div class="col-md-6 col-12">
                                      <div class="form-group">
                                        <label>Address</label>
                                        <input type="text" id="email-id-column" class="form-control {{ $errors->has('cust_address') ? 'is-invalid' : ''}}" name="cust_address">
                                  ...
                                  <div class="col-md-6 col-12">
                                     <div class="form-group">
                                            <label>Group</label>
                                             <select class="select2 form-control {{ $errors->has('cust_group') ? 'is-invalid' : ''}} select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="cust_group">
