    ...
    <div class="content-header-right text-md-right col-md-3 col-12 d-md-block d-none">
        <div class="form-group breadcrum-right">
            ...
            <div class="dt-buttons btn-group">
                <a href="{{route('customers.create')}}"><button class="btn btn-success" tabindex="0" aria-controls="DataTables_Table_0">
                <span><i class="feather icon-plus"></i> New Customer</span></button></a>
            </div>
                 </div>
        </div>
    </div>
