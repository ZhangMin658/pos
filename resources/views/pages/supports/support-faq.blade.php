              ...
              <div class="card-body">
                  ...
                  <div class="faq-content mt-1">
                      <div class="faq-table-content">
                          <i class="fa fa-circle success"></i> All
                      </div>
                      <div class="faq-table-content">
                          <i class="fa fa-circle success"></i> Bank Account
                      </div>
                      <div class="faq-table-content">
                          <i class="fa fa-circle success"></i> Services
                      </div>
                      <div class="faq-table-content">
                          <i class="fa fa-circle success"></i> Invoicing
                      </div>
                      <div class="faq-table-content">
                          <i class="fa fa-circle success"></i> Security
                      </div>
                      <div class="faq-table-content">
                          <i class="fa fa-circle success"></i> My Account
                      </div>
                      <div class="faq-table-content">
                          <i class="fa fa-circle success"></i> Client
                      </div>
                      <div class="faq-table-content">
                          <i class="fa fa-circle success"></i> Reports
                      </div>
                      <div class="faq-table-content">
                          <i class="fa fa-circle success"></i> Team
                      </div>
                  </div>
