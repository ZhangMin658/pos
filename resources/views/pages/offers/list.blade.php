...
<div class="btn-group dropdown actions-dropodown">
          ...
          <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 43px, 0px);">
            <a class="dropdown-item" href="categories_list">Manage categories</a>
            <a class="dropdown-item" href="attributes_list">Manage Attributes</a>
            <a class="dropdown-item" href="#">Import Products</a>
            <a class="dropdown-item" href="#">Export Products</a>
            <a class="dropdown-item" href="#">Inventory</a>
            <a class="dropdown-item" href="#">Deleted Products</a>
             </div>
        </div>
        <div class="dt-buttons btn-group">
                <a href="products_new"><button class="btn btn-success" tabindex="0" aria-controls="DataTables_Table_0">
                <span><i class="feather icon-plus"></i> New product</span></button></a>
                 </div>
                 </div>
        </div>
    </div>
