        ...
        <ul class="nav nav-pills flex-column mt-md-0 mt-1">
          <li class="nav-item">
            <a class="nav-link d-flex py-75 active" id="account-pill-general" data-toggle="pill"
              ...
              <i class="fas fa-shopping-cart mr-50 font-medium-3"></i>
              Sales Report
            </a>
          </li>
          <li class="nav-item">
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="form-group">
                          <div class="controls">
                            <label for="account-username">From Date</label>
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          <div class="controls">
                            <label for="account-name">To Date</label>
                      ...
                      <div class="col-12 d-flex flex-sm-row flex-column justify-content-end">
                        <button type="submit" class="btn btn-primary mr-sm-1 mb-1 mb-sm-0">Generate Report</button>
                   </div>
                    </div>
                  </form>
                </div> </div>
