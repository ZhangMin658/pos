...
/*
 ...
 |--------------------------------------------------------------------------
 */
mixAssetsDir('vendors/css/login/*.js', (src, dest) => mix.scripts(src, dest));
mixAssetsDir('vendors/css/login/*.css', (src, dest) => mix.copy(src, dest));
...
mixAssetsDir('vendors/pos2/*.js', (src, dest) => mix.scripts(src, dest));
mixAssetsDir('vendors/pos2/*.css', (src, dest) => mix.copy(src, dest));
